<template>
  <section class="relative mx-auto max-w-[85rem] px-4 pb-24 pt-10 sm:px-6 lg:px-8">
    ...
    <div
      ...
      <svg
        ...
        <path
          ...
          d="M12 23a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM3 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM3 18a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"></path>
        <path
          stroke="#ea580c"
          stroke-linecap="round"
          stroke-linejoin="round"
          d="M21 7.353v9.294a.6.6 0 0 1-.309.525l-8.4 4.666a.6.6 0 0 1-.582 0l-8.4-4.666A.6.6 0 0 1 3 16.647V7.353a.6.6 0 0 1 .309-.524l8.4-4.667a.6.6 0 0 1 .582 0l8.4 4.667a.6.6 0 0 1 .309.524Z"></path>
        <path
          stroke="#ea580c"
          stroke-linecap="round"
          stroke-linejoin="round"
    ...
    <div class="absolute bottom-[5%] left-[60%] scale-[.6] xl:bottom-[15%] xl:left-[35%]">
      <svg
        ...
        <path
          ...
          stroke-linecap="round"
          stroke-linejoin="round"
          d="M5.164 17c.29-1.049.67-2.052 1.132-3M11.5 7.794A16.838 16.838 0 0 1 14 6.296M4.5 22a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5Z"></path>
        <path
          stroke="#a3a3a3"
          stroke-linecap="round"
          stroke-linejoin="round"
    ...
    <div class="mx-auto mt-5 max-w-3xl text-center">
      <p
        v-if="subtitle"
        class="text-pretty text-lg text-neutral-600 dark:text-neutral-400">
        {{ subtitle }}
      </p>
    </div>

    <!-- Github Button -->
    <div v-if="githubUrl" class="mt-8 flex justify-center gap-3">
      <a
        class="group inline-flex items-center justify-center gap-x-3 rounded-full px-4 py-3 text-center text-sm font-medium text-[var(--ui-text)] transition duration-300 outline-none border border-transparent bg-[var(--ui-primary)] hover:shadow-2xl hover:shadow-[color:var(--ui-primary)]"
        :href="githubUrl"
        target="_blank"
...
defineProps<{ title: string; subtitle?: string; githubUrl?: string }>();
</script>
